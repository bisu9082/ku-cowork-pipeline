...
- 실행 래퍼: `scripts/run_provenance_audit.py`
...
`scripts/run_provenance_audit.py [제출폴더] --watermarks-dir watermarks-remover --format json --out workspace/Step7/provenance_audit.json`

완료 보고에 반드시 포함:
`PROV-AUDIT: [pass/review-needed] | report: [path] | disclosure: [none/needed/included]`
